...
(subtest "BUILT-IN-FUNCTION-RETURN-TYPE"
  (loop for (opes args ret) in '(((+ * - / mod) (int int) int)
                                 ...
                                 ((clamp) (uint4 uint uint) uint4)
                                 ((clamp) (float4 float4 float4) float4)
                                 ((clamp) (float4 float float) float4)
                                 ((upsample) (short4 ushort4) int4)
                                 ((logior logand) (char char) char)
                                 ((logior logand) (uchar uchar) uchar)
                                 ((logior logand) (short short) short)
                                 ((logior logand) (ushort ushort) ushort)
                                 ((logior logand) (int int) int)
                                 ((logior logand) (uint uint) uint)
                                 ((logior logand) (long long) long)
                                 ((logior logand) (ulong ulong) ulong)
                                 ((<< >>) (int uint) int)
                                 ((dot) (float2 float2) float)
                                 ((dot) (float3 float3) float)
                                 ((dot) (float4 float4) float)
                                 ((dot) (double2 double2) double)
                                 ((dot) (double3 double3) double)
                                 ((dot) (double4 double4) double))
        do (dolist (ope opes)
